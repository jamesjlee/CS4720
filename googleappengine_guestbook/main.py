                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li class="page-scroll">
                                                <a href="http://plato.cs.virginia.edu/~jjl9ve/final/">Go back to Cube</a>
                                        </li>
                                        <li class="page-scroll">
...
#Create cookie to store content which expires in 20 years
c = Cookie.SimpleCookie()
c['content']= ''
c['content']['expires']= 12 * 30 * 24 * 60 * 60
...
class Logout(webapp2.RequestHandler):
    def get(self):
        self.redirect(users.create_logout_url('http://plato.cs.virginia.edu/~jjl9ve/final/'))
